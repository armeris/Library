...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <div class="errors">
                <g:renderErrors bean="${editorialInstance}" as="list" />
            </div>
            </g:hasErrors>
            <g:form method="post" >
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="nombre"><g:message code="editorial.nombre.label" default="Nombre" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: editorialInstance, field: 'nombre', 'errors')}">
